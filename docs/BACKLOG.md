...
- [ ] **1.1 Paste a repo, watch its tree grow** — *the wow moment; must land first.*
...
- [ ] **1.2 Full commit history via paginated fetch**
...
- [ ] **1.3 Per-year language detection for color banding**
